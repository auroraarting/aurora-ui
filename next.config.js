...
const nextConfig = {
	...
	async headers() {
        ...
        `
					...
					},
					{
						key: "X-Frame-Options",
						value:
							"ALLOW-FROM https://www-production.auroraer.com https://www-staging.auroraer.com/ https://staging-aurora-ui.vercel.app/ /",
					},
					{
					...
					},
					{
						...
						value:
							"https://www-production.auroraer.com https://www-staging.auroraer.com/ https://staging-aurora-ui.vercel.app/ /",
					},
					{
	...
	async redirects() {
		return [
			...
			{
				source: "/",
				destination: "https://www.auroraer.com/",
				permanent: true,
			},
			{
				source: "/events/spring-forum/",
			...
			},
			{
				source: "/category/insight-type/commentary/",
				destination:
					"https://www.auroraer.com/resources/aurora-insights?category=Commentary",
				permanent: true,
			},
			{
				source: "/category/subscription/software/",
			...
			{
				source:
					"/insight/charting-the-future-chiles-pmgd-stabilized-price-outlook/",
				destination:
					"/resources/aurora-insights/market-reports/charting-the-future-chiles-pmgd-stabilized-price-outlook",
				permanent: true,
			},
			{
				source: "/software/origin/",
				destination: "https://www.auroraer.com/software/origin",
				permanent: true,
			},
			{
			...
			},
			{
				...
				destination: "https://www.auroraer.com/software/amun",
				permanent: true,
			},
			{
				source: "/software/chronos/chronos-for-germany/",
			...
			},
			{
				source: "/market-reports/",
				destination:
					"https://www.auroraer.com/resources/aurora-insights?category=Market+reports",
				permanent: true,
			},
			{
				source: "/insights/",
				destination: "https://www.auroraer.com/resources/aurora-insights",
				permanent: true,
			},
			{
				source: "/category/insight/",
			...
			},
			{
				...
				destination: "/policies-and-compliance",
				permanent: true,
			},
			{
				source: "/products/power-renewables-service/",
				destination: "/products/power-renewables-service",
				permanent: true,
			},
			{
				source: "/legal/terms/",
			...
			{
				source:
					"/graduate-programmes/?utm_source=LifeatAurora+web&utm_medium=Web&utm_campaign=LifeatAurora+web&utm_id=LifeatAurora_web",
				destination:
					"/careers/early-careers?utm_source=LifeatAurora%20web&utm_medium=Web&utm_campaign=LifeatAurora%20web&utm_id=LifeatAurora_web",
				permanent: true,
			},
			{
			...
			{
				source:
					"/insight/battery-blitz-a-guide-to-the-enduring-auction-capability/",
				destination:
			...
			{
				source:
					"/insight-type/commentary/comment-ds3-system-service-tariff-review/",
				destination:
			...
			{
				source:
					"/insight/from-brazil-to-europe-the-renewable-hydrogen-opportunity/",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			},
			{
				source:
					"/media/frances-battery-market-expected-to-expand-rapidly-by-2030-but-faces-saturation-risks-aurora-says/",
				destination:
					"https://www.auroraer.com/company/press-room/frances-battery-market-expected-to-expand-rapidly-by-2030-but-faces-saturation-risks-aurora-says",
				permanent: true,
			},
			{
				source:
					"/country/europe/nordics-and-iberia-step-up-as-europes-hydrogen-frontrunners/",
				destination:
					"https://www.auroraer.com/company/press-room/nordics-and-iberia-step-up-as-europes-hydrogen-frontrunners",
				permanent: true,
			},
			{
				source:
			...
			},
			{
				source:
					"/webinar/shifting-currents-nodal-price-forecasting-and-grid-congestion-in-nyiso-2/",
				destination:
					"https://www.auroraer.com/resources/webinar/shifting-currents-nodal-price-forecasting-and-grid-congestion-in-nyiso-2",
				permanent: true,
			},
			{
				source:
					"/webinar/miso-market-outlook-coal-retirements-and-resource-adequacy/",
				destination:
					"https://www.auroraer.com/resources/webinar/miso-market-outlook-coal-retirements-and-resource-adequacy-concerns-2",
				permanent: true,
			},
			{
				source:
					"/webinar/electricity-demand-in-brazil-data-centers-evs-and-hydrogen/",
				destination:
					"https://www.auroraer.com/resources/webinar/electricity-demand-in-brazil-data-centers-evs-and-hydrogen",
				permanent: true,
			},
			{
				source:
					"/webinar/from-volatility-to-value-negative-prices-and-batteries-in-the-baltics/",
				destination:
					"https://www.auroraer.com/resources/webinar/from-volatility-to-value-negative-prices-and-batteries-in-the-baltics",
				permanent: true,
			},
			{
				source:
			...
			{
				source: "/?post_type=tribe_events&p=28171",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
				source: "/?post_type=tribe_events&p=28174",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			{
				source:
					"/webinar/from-brazil-to-europe-the-renewable-hydrogen-opportunity/",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			{
				source:
					"日本における水素の経済性：第３四半期ご購読者向けオンラインセッション",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			{
				source:
					"/webinar/part-2-negative-prices-and-cfds-quantifying-the-downside/",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			{
				source:
					"/webinar/canadian-power-markets-and-the-project-finance-landscape/",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			{
				source:
					"/webinar/kraftwerkssicherheitsgesetz-gas-power-generation-germany/",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			{
				source: "/?post_type=tribe_events&p=35213",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			{
				source:
					"/webinar/a-shift-in-iberian-demand-from-machinery-to-data-centres/",
				destination: "/resources/webinar",
				permanent: true,
			},
			{
			...
			{
				source:
					"/webinar/below-zero-understanding-negative-power-prices-in-iberia/",
				destination:
					"/resources/webinar/below-zero-understanding-negative-power-prices-in-iberia",
				permanent: true,
			},
			{
				source: "/?post_type=tribe_events&p=37133",
				destination: "/resources/webinar/introducing-auroras-battery-benchmark",
				permanent: true,
			},
			{
			...
			},
			{
				...
				destination:
					"auroraer.com/resources/webinar/speed-and-scale-load-growth-potential-in-alberta-2",
				permanent: true,
			},
			{
				source:
					"/webinar/charting-the-future-chiles-pmgd-stabilized-price-outlook/",
				destination:
			...
			{
				source: "/?post_type=tribe_events&p=37729",
				destination: "/resources/webinar/battery-investments-in-the-netherlands",
				permanent: true,
			},
			{
			...
			},
			{
				...
				destination:
					"/resources/webinar/%E8%BB%A2%E6%8F%9B%E6%9C%9F%E3%81%AB%E3%81%82%E3%82%8B%E6%97%A5%E6%9C%AC%E3%81%AE%E9%9B%BB%E5%8A%9B%E9%9C%80%E8%A6%81%EF%BC%9A%E7%99%BA%E9%9B%BB%E3%83%9F%E3%83%83%E3%82%AF%E3%82%B9%E3%83%BB-%E9%9B%BB?search=%E8%BB%A2%E6%8F%9B%E6%9C%9F%E3%81%AB%E3%81%82%E3%82%8B%E6%97%A5%E6%9C%AC%E3%81%AE%E9%9B%BB%E5%8A%9B%E9%9C%80%E8%A6%81%EF%BC%9A%E7%99%BA%E9%9B%BB%E3%83%9F%E3%83%83%E3%82%AF%E3%82%B9%E3%83%BB%20%E9%9B%BB%E5%8A%9B%E4%BE%A1%E6%A0%BC%E3%83%BB%E9%9B%BB%E6%BA%90%E6%8A%95%E8%B3%87%E3%81%B8%E3%81%AE%E5%BD%B1%E9%9F%BF",
				permanent: true,
			},
			{
				source:
			...
			{
				source:
					"/webinar/western-regionalization-caisos-extended-day-ahead-market/",
				destination:
			...
			{
				source: "/?post_type=tribe_events&p=39015",
				destination:
					"/resources/webinar/boosting-the-returns-on-a-solar-asset-co-location-with-battery-storage-and-impact-of-market-volatility",
				permanent: true,
			},
			{
				source:
