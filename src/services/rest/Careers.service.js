...
/** The ACF group matching a GraphQL field name, or null when absent.
 *
 *  ACF keys drift from the names GraphQL exposed - case, separators and
 *  ampersands - so both sides are normalised before comparing, and the
 *  `_source` companion keys ACF writes alongside relations are skipped. */
