					...
					<SwiperSlide>
						<div className={`${styles.cardItem} f_r_aj_between`}>
							<div className={`${styles.cardDesc}`}>
								...
								<p className="text_reg color_dark_gray font_secondary f_w_r pt_10">
									Teamwork is fundamental to our culture, evident both in and outside the
									office! Our Offsite events feature engaging team-building activities,
									from constructing bamboo rollercoasters to attending painting classes,
									and the opportunity to strengthen social bonds among colleagues.
								</p>
							</div>
							<div className={`${styles.cardImg}`}>
								<img
